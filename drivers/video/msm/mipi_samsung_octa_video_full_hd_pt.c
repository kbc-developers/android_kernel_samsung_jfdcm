...
static int brightness_control(int bl_level)
{
	...
	*/
	...
	pr_debug("%s: candela = %d, aor 1st=0x%x, 6th=0x%x, 7th=0x%x \n",
		__func__, candela, samsung_brightness_aor_ref[1],
		samsung_brightness_aor_ref[6], samsung_brightness_aor_ref[7]);
	...
	pr_debug("%s: candela = %d, elvss 1st=0x%x, 2nd=0x%x\n", __func__,
		candela, samsung_brightness_elvss_ref[1],
		samsung_brightness_elvss_ref[2]);
